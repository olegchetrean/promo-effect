...
export const PackageIcon = (props: IconProps) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M16.5 9.4a4.5 4.5 0 1 1-9 0 4.5 4.5 0 0 1 9 0Z" /><path d="M12 14.1V22" /><path d="M12 2v2.5" /><path d="M12 11.5a2.5 2.5 0 0 1-2.5-2.5V3h5v6a2.5 2.5 0 0 1-2.5 2.5Z" /><path d="M20 9a8 8 0 0 0-8-8" /><path d="M4 9a8 8 0 0 1 8-8" />
  </svg>
);

export const ShipIcon = (props: IconProps) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M2 21c.6.5 1.2 1 2.5 1 2.5 0 2.5-2 5-2 2.5 0 2.5 2 5 2 2.5 0 2.5-2 5-2 1.3 0 1.9-.5 2.5-1" /><path d="M19.38 20A11.6 11.6 0 0 0 12 14a11.6 11.6 0 0 0-7.38 6" /><path d="M20.21 15.33 12 7 3.79 15.33" /><path d="M12 7V2" />
  </svg>
);
...
export const CalculatorIcon = (props: IconProps) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="16" height="20" x="4" y="2" rx="2" /><line x1="8" x2="16" y1="6" y2="6" /><line x1="16" x2="16" y1="14" y2="18" /><line x1="16" x2="8" y1="10" y2="10" /><line x1="8" x2="8" y1="14" y2="18" /></svg>
);
...
// FIX: Changed StarIcon to be a React.FC to correctly handle the 'key' prop.
export const StarIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" /></svg>
);
...
export const TwitterIcon = (props: IconProps) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 4s-.7 2.1-2 3.4c1.6 1.4 3.3 4.4 3.3 4.4s-1.4-.6-2.8-.9c-1.4 2.6-4.3 4.1-4.3 4.1s-1.5-1.1-2.2-2.3c-1.1 1.8-3 3.1-3 3.1s-1.1-1.3-1.4-2.3C2 18.2 2 13.3 2 13.3s2.6-.9 5.2-2.2c-1.4-.4-2.8-1.8-2.8-1.8s.4 1.1 1.7 1.4S8.8 11.1 8.8 11.1s-1.2-1.8-1.5-3.2C7.3 6.9 7.3 4 7.3 4s2.6 3.4 6.8 4.4c0 0 .1-.6.3-1.2.3-1.2 1.1-2.1 2.1-2.4 1.1-.3 2.3 0 3.2.8.6-.2 1.2-.4 1.7-.6.3 1.1.2 1.9.2 1.9z" /></svg>
);
